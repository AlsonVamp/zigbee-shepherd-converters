    ...
    ETT_SPRY_schedule: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (value.hasOwnProperty('schedule')) {
                payload[0] = {value: ett.scheduleToOctetStr(value.schedule), type: 0x41};
            }
            if (value.hasOwnProperty('intensity')) {
                payload[2] = {value: value.intensity, type: 0x20};
            }
            if (value.hasOwnProperty('intervals')) {
                payload[1] = {value: ett.intervalsToOctetStr(value.intervals), type: 0x41};
            }
